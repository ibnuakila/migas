...
import "classnames";
function ListIndikatorPeriode({ auth }) {
    ...
    AdminLayout,
    {
      ...
      children: /* @__PURE__ */ jsx("div", { className: "container mx-auto", children: /* @__PURE__ */ jsxs(Card, { className: "p-5 h-full w-full overflow-scroll", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between", children: [
          /* @__PURE__ */ jsx(Typography, { variant: "h3", children: "Data Indikator Periode" }),
          /* @__PURE__ */ jsx("div", { className: "flex", children: /* @__PURE__ */ jsx("span", { children: /* @__PURE__ */ jsx(Input, { variant: "outlined", size: "md", className: "w-45", label: "Search..", onChange: handleChange }) }) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex my-2", children: [
          /* @__PURE__ */ jsx(Link, { href: route("indikator-periode.create"), children: /* @__PURE__ */ jsx(Button, { size: "sm", className: "ml-2", onClick: () => setOpen(true), color: "blue", children: "Add" }) }),
          /* @__PURE__ */ jsx(Button, { size: "sm", className: "ml-2", onClick: handleImport, color: "green", children: "Import Indikator" })
        ] }),
        /* @__PURE__ */ jsxs("table", { className: "w-full min-w-max table-auto text-left", children: [
          ...
          /* @__PURE__ */ jsxs("tbody", { children: [
            indikator_periodes.data.map(({ id, nama_indikator, periode, target, indikator_periode_pic }) => /* @__PURE__ */ jsxs("tr", { className: "even:bg-blue-gray-50/50", children: [
              ...
              /* @__PURE__ */ jsx("td", { children: /* @__PURE__ */ jsx(Typography, { variant: "small", color: "blue-gray", className: "font-normal", children: target }) }),
              /* @__PURE__ */ jsx("td", { children: /* @__PURE__ */ jsx("div", { className: "flex", children: indikator_periode_pic.map(({ id: id2, nama_pic }) => /* @__PURE__ */ jsx(Typography, { variant: "small", color: "blue-gray", className: "font-normal ml-1", children: nama_pic })) }) }),
              /* @__PURE__ */ jsx("td", { className: "p-4", children: /* @__PURE__ */ jsx(Typography, { as: "a", href: "#", title: "Edit", variant: "small", color: "blue-gray", className: "font-normal text-center", children: /* @__PURE__ */ jsx(Link, { href: route("indikator-periode.edit", id), children: /* @__PURE__ */ jsx("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: "1.5", stroke: "currentColor", className: "w-6 h-6", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" }) }) }) }) })
            ] }, id)),
...
export {
  ListIndikatorPeriode as default
};
