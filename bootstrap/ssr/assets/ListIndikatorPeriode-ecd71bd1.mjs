  ...
  return /* @__PURE__ */ jsx(
    AdminLayout,
    {
      ...
      children: /* @__PURE__ */ jsx("div", { className: "container mx-auto", children: /* @__PURE__ */ jsxs(Card, { className: "p-5 h-full w-full overflow-scroll", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex my-2", children: /* @__PURE__ */ jsx(Link, { href: route("indikator-periode.create"), children: /* @__PURE__ */ jsx(Button, { size: "sm", className: "ml-2", onClick: () => setOpen(true), color: "blue", children: "Add" }) }) }),
        /* @__PURE__ */ jsxs("table", { className: "w-full min-w-max table-auto text-left", children: [
          ...
          /* @__PURE__ */ jsxs("tbody", { children: [
            data.map(({ Id, Periode, Status }) => /* @__PURE__ */ jsxs("tr", { className: "even:bg-blue-gray-50/50", children: [
