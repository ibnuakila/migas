...
function AdminLayout({ auth, children }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "max-h-full bg-cyan-50", children: /* @__PURE__ */ jsx("div", { className: "container py-10 pt-1 pb-1 mx-auto flex flex-wrap ", children: /* @__PURE__ */ jsxs("div", { className: "flex py-2 mb-1", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "max-h-full bg-cyan-50", children: [
      " ",
      children,
      " "
    ] }),
    /* @__PURE__ */ jsx("section", { className: "p-2 h-auto ", children: /* @__PURE__ */ jsx("footer", { className: "footer relative pt-1 border-b-2 border-blue-200", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-6", children: [
