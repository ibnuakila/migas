    ...
    /*useEffect(() => {
        ...
        router.visit('/kompositor/index-indikator/' + indikator.id, {
            ...
            onCancelToken: (cancelToken) => {
                // Optional: Store the cancel token if you want to cancel future requests
            },
            onCancel: () => {
                ...
                <div className="mx-auto">
                    <Card className="mt-12 mb-8 flex flex-col gap-12">
                        <CardHeader variant="gradient" color="blue-gray" className="mb-4 grid h-20 place-items-center">
                            {indikator ? (
                                <Typography variant="h4">Kompositor/Parameter Indikator: {indikator.nama_indikator} ({indikator.level.nama_level})</Typography>
                            ) : (
