...
export default function ListHasilEvaluasi({auth}){ 
        ...
        children={(
                <div className="container mx-auto">
                    ...
                    <div className="flex justify-between">
                        <Typography variant="h3">Hasil Evaluasi SAKIP                           
                        </Typography>
                        <span><Input variant="outlined" size="md" className="w-45" label="Search.." /></span>
                    </div>
                    <div className="flex my-2">
                    <Link href={route('hasil-evaluasi.create')}>
                        ...
                        <table className="w-full min-w-max table-auto text-left">
                            ...
                            <tbody>                                                      
                                {data.map(({Id, TanggalEvaluasi, Status, Keterangan, Evaluator}) => (
